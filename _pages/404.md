...
I am a postdoctoral research associate in Imperial College London’s [Neural Reckoning group](https://neural-reckoning.org/), collaborators: Dr Dan Akarca and [Prof Dan Goodman](https://neural-reckoning.org/dan_goodman.html).  I was funded by the Research Foundation – Flanders (FWO) during my PHD, and was the recipient of [Chinese Government Award for Outstanding Students Abroad](https://en.wikipedia.org/wiki/Chinese_Government_Award_for_Outstanding_Self-Financed_Students_Abroad). I was also a researcher at Waves-IMEC, Ghent University, Belgium, A*STAR, Singapore and INI, UZH/ETHZ, Switzerland. My current research interests are **foundation models**,  **brain-inspired memory module**, and **temporal learning**.
