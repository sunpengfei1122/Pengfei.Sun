...
I will be joining Imperial College London’s Neural Reckoning group to focus on delay learning and neuromorphic computing. I am lucky to be mentored  by Dr.Dan Akarca,  Dr.Jascha Achterberg, and Dr.Dan Goodman. I welcome discussions on **spiking neural networks**, **efficient AI**, and **neuromorphic architectures**, and I’m particularly interested in **exploring the scalability of delay learning in both spiking and non-spiking recurrent neural networks**. Please feel free to reach out if you’d like to discuss any of these topics.

I earned my PhD in Computer Science Engineering from Ghent University (Belgium), where I specialized in neuromorphic computing, machine learning, and speech & EEG processing. I was honored to receive the Chinese National Award for Outstanding PhD Students Abroad (2025).  My research spans neuromorphic device architectures, spiking-neural algorithms, and adaptive delay mechanisms for both biological and artificial neural systems.
