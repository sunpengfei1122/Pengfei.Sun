...
📄 <strong>Sun, P.</strong>, Su, Z*., Achterberg, J., Indiveri, G., Goodman, D. F. M., & Akarca, D. (2026).<br> <strong>Algorithm-hardware co-design of neuromorphic networks with dual memory pathways.</strong><br> <em>Nature Machine Intelligence</em>. DOI: 10.1038/s42256-026-01255-3 <a href="https://arxiv.org/abs/2512.07602" target="_blank"><button>Arxiv</button></a> <button onclick="showBibtex('bib-dmp')">Cite</button> <div id="bib-dmp" style="display:none; position:fixed; top:20%; left:50%; transform:translateX(-50%); background:#fff; border:1px solid #ccc; padding:1em; z-index:100; max-width:600px;"> <pre id="txt-dmp" style="white-space:pre-wrap;"> @article{sun2026algorithm, title={Algorithm-hardware co-design of neuromorphic networks with dual memory pathways}, author={Sun, Pengfei and Su, Zhe and Achterberg, Jascha and Indiveri, Giacomo and Goodman, Dan F. M. and Akarca, Danyal}, journal={Nature Machine Intelligence}, year={2026}, doi={10.1038/s42256-026-01255-3} } </pre> <button onclick="copyBib('txt-dmp')">Copy</button> <button onclick="hideBib('bib-dmp')">Close</button> </div>
