...
I welcome discussions on delay learning and lightweight attention mechanisms in both rate- and spike-based recurrent neural networks. Additionally, I am keen on exploring the scalability of delay learning in both spiking and non-spiking RNNs. Please feel free to contact me at p.sun@imperial.ac.uk.
...
<!-- 只有当 URL 带 ?owner=true 时才会注入访客统计 -->
<script>
  // 检查 URL 参数
  ...
  if (isOwner) {
    ...
    div.innerHTML = `
      <p>🌐 Total visitors: <span id="busuanzi_value_site_uv"></span></p>
      <p>📍 Your country: <span id="visitor-country">loading…</span></p>
    `;
    document.body.appendChild(div);

    // Busuanzi
    const s1 = document.createElement('script');
    s1.src = 'https://busuanzi.ibruce.info/busuanzi/2.3/busuanzi.pure.mini.js';
    s1.async = true;
    ...
    fetch('https://ipapi.co/json/')
      ...
      .catch(_ => {
        document.getElementById('visitor-country').textContent = 'Unknown';
      });
  }
</script>
